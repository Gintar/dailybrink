...
/*
	...
	$(".b0").click(
		function(){
		$('.archivePerson').animate({"opacity": "1"}, "fast");
		}
	)
	...
	$(".b1").click(
		...
		$('.archivePerson').animate({"opacity": "0"}, "fast");
		$('.arts').stop().animate({"opacity": "1"}, "fast");
	...
	$(".b2").click(
		...
		//$('.archivePerson').fadeOut(500);
		$('.archivePerson').animate({"opacity": "0"}, "fast");
		$('.athletics').stop().animate({"opacity": "1"}, "fast");
	...
	$(".b3").click(
		function(){
		$('.archivePerson').animate({"opacity": "0"}, "fast");
		$('.business').stop().animate({"opacity": "1"}, "fast");
	...
	$(".b4").click(
		function(){
		$('.archivePerson').animate({"opacity": "0"}, "fast");
		$('.education').stop().animate({"opacity": "1"}, "fast");
	...
	$(".b5").click(
		function(){
		$('.archivePerson').animate({"opacity": "0"}, "fast");
		$('.social').stop().animate({"opacity": "1"}, "fast");
	...
	$(".b6").click(
		function(){
		$('.archivePerson').animate({"opacity": "0"}, "fast");
		$('.tech').stop().animate({"opacity": "1"}, "fast");
	...
	$(".b7").click(
		function(){
		$('.archivePerson').animate({"opacity": "0"}, "fast");
		$('.other').stop().animate({"opacity": "1"}, "fast");
...
<div id="archiveHolder">
	...
	<div id="archiveLeft">
		...
		<div id="archiveLeftButtons">
			...
			<a class="b5" style="cursor:pointer"><div class="button"><span class="purple">social activism</span><hr /></div></a>
			<a class="b6" style="cursor:pointer"><div class="button"><span class="lightblue">tech/sciences</span><hr /></div></a>
			<a class="b7" style="cursor:pointer"><div class="button"><span class="pink">other</span><hr /></div></a>
			</div>
		</div>
	</div>
...
?>
			...
			<?php if (have_posts()) : ?>
				...
				<?php while (have_posts()) : the_post(); ?>
					...
					<?php global $counter; if($counter%5==0) : ?> <div style="margin-top:10px;height:280px;"> <?php endif; ?>

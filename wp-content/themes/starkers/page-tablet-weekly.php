<?php
/*
Template Name: Tablet - Weekly
*/
?>

<?php if( $_GET["page_id"] == 2045) { query_posts( 'posts_per_page=1&post_type=tablet&day_of_the_week=monday' ); } ?>
<?php if( $_GET["page_id"] == 2046) { query_posts( 'posts_per_page=1&post_type=tablet&day_of_the_week=tuesday' ); } ?>
<?php if( $_GET["page_id"] == 2047) { query_posts( 'posts_per_page=1&post_type=tablet&day_of_the_week=wednesday' ); } ?>
<?php if( $_GET["page_id"] == 2048) { query_posts( 'posts_per_page=1&post_type=tablet&day_of_the_week=thursday' ); } ?>
<?php if( $_GET["page_id"] == 2049) { query_posts( 'posts_per_page=1&post_type=tablet&day_of_the_week=friday' ); } ?>
